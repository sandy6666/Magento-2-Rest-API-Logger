...
namespace Sandesh\WebApiLog\Plugin\Rest;

class Api
{
    /** @var \Sandesh\WebApiLog\Logger\Handler */
    protected $logger;
    ...
    /**
     * Rest constructor.
     * @param \Sandesh\WebApiLog\Logger\Handler $logger
     */
    public function __construct(\Sandesh\WebApiLog\Logger\Handler $logger)
    {
        $this->logger = $logger;
    }
